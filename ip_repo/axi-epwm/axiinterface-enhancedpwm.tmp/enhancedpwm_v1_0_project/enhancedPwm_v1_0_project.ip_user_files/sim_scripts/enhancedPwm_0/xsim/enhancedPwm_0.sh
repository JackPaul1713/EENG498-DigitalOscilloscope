...
#
# Script generated by Vivado on Tue Nov 14 19:10:17 -0700 2023
# SW Build 3865809 on Sun May  7 15:05:29 MDT 2023
#
# Tool Version Limit: 2023.05 
#
# Filename     : enhancedPwm_0.sh
...
#
# Usage        : enhancedPwm_0.sh
#                enhancedPwm_0.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                enhancedPwm_0.sh [-reset_run]
#                enhancedPwm_0.sh [-reset_log]
#                enhancedPwm_0.sh [-help]
#
...
# script info
echo -e "enhancedPwm_0.sh - Script generated by export_simulation (Vivado v2023.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./enhancedPwm_0.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L secureip -L xpm --snapshot enhancedPwm_0 xil_defaultlib.enhancedPwm_0 -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim enhancedPwm_0 -key {Behavioral:sim_1:Functional:enhancedPwm_0} -tclbatch cmd.tcl -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb enhancedPwm_0.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./enhancedPwm_0.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: enhancedPwm_0.sh [-help]\n\
Usage: enhancedPwm_0.sh [-step]\n\
Usage: enhancedPwm_0.sh [-lib_map_path]\n\
Usage: enhancedPwm_0.sh [-reset_run]\n\
Usage: enhancedPwm_0.sh [-reset_log]\n\
Usage: enhancedPwm_0.sh [-keep_index]\n\
Usage: enhancedPwm_0.sh [-noclean_files]\n\n\
