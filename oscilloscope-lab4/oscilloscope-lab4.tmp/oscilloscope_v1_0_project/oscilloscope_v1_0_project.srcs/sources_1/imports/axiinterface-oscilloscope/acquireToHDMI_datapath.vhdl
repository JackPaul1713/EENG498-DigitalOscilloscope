...
architecture behavior of acquireToHDMI_datapath is
    ...
    -- flags:
    signal sampReadyFlagVec, sampReadyVec, sampRecivedVec: std_logic_vector(0 downto 0);
    -- control word:
...
begin
    ...
    -- flags:
    sampReadyFlag <= sampReadyFlagVec(0);
    sampReadyVec(0) <= rate;
    sampRecivedVec(0) <= sampRecived;
    sampReadyReg: flagRegister
        generic map(1)
        port map(Q => sampReadyFlagVec, set => sampReadyVec, clear => sampRecivedVec, clk => clk, resetn => resetn);
