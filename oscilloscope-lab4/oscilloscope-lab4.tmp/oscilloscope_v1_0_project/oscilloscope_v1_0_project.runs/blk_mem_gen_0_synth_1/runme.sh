...
HD_PWD='c:/users/jackpaul/onedrive/documents/programs/projects/eeng498/oscilloscope-lab4/oscilloscope-lab4.tmp/oscilloscope_v1_0_project/oscilloscope_v1_0_project.runs/blk_mem_gen_0_synth_1'
cd "$HD_PWD"
