...
#
# Script generated by Vivado on Sun Dec 03 16:17:07 -0700 2023
# SW Build 3865809 on Sun May  7 15:05:29 MDT 2023
#
# Tool Version Limit: 2023.05 
#
# Filename     : oscope_0.sh
...
#
# Usage        : oscope_0.sh
#                oscope_0.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                oscope_0.sh [-reset_run]
#                oscope_0.sh [-reset_log]
#                oscope_0.sh [-help]
#
...
# script info
echo -e "oscope_0.sh - Script generated by export_simulation (Vivado v2023.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./oscope_0.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L blk_mem_gen_v8_4_6 -L xilinx_vip -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot oscope_0 xil_defaultlib.oscope_0 xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim oscope_0 -key {Behavioral:sim_1:Functional:oscope_0} -tclbatch cmd.tcl -protoinst "protoinst_files/zyncoscope.protoinst" -log simulate.log
}
...
map_local_libs()
{
  ...
  local_libs=(xil_defaultlib blk_mem_gen_v8_4_6)
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb oscope_0.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./oscope_0.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: oscope_0.sh [-help]\n\
Usage: oscope_0.sh [-step]\n\
Usage: oscope_0.sh [-lib_map_path]\n\
Usage: oscope_0.sh [-reset_run]\n\
Usage: oscope_0.sh [-reset_log]\n\
Usage: oscope_0.sh [-keep_index]\n\
Usage: oscope_0.sh [-noclean_files]\n\n\
