...
#
# Script generated by Vivado on Sun Dec 10 23:11:12 -0700 2023
# SW Build 3865809 on Sun May  7 15:05:29 MDT 2023
#
# Tool Version Limit: 2023.05 
#
# Filename     : zyncoscope.sh
...
#
# Usage        : zyncoscope.sh
#                zyncoscope.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                zyncoscope.sh [-reset_run]
#                zyncoscope.sh [-reset_log]
#                zyncoscope.sh [-help]
#
...
#                script (type 'zyncoscope.sh -help' for more information).
#
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./zyncoscope.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.zyncoscope xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.zyncoscope -input simulate.do
}
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log zyncoscope_sc.so .tmp_log xcelium_lib waves.shm c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./zyncoscope.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: zyncoscope.sh [-help]\n\
Usage: zyncoscope.sh [-step]\n\
Usage: zyncoscope.sh [-lib_map_path]\n\
Usage: zyncoscope.sh [-reset_run]\n\
Usage: zyncoscope.sh [-reset_log]\n\
Usage: zyncoscope.sh [-keep_index]\n\
Usage: zyncoscope.sh [-noclean_files]\n\n\
